...
# repo dir on shard-a's host (OneDrive/NTFS proxy is too slow). This
...
#        --owner shard-a --runtime docker --workers 1 --timeout 600
set -euo pipefail

REPO="$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)"
# Two venvs (see bench/setup_wsl_venv.sh and bench/SETUP_LOG_shard_a_synthetic.md):
