...
Usage (shard-a, Windows/WSL, synthetic):
...
Usage (shard-b, Adroit, realworld, gdb-only first then bash-only):
    python -m bench.run_runset_shard \
        --runset bench/results/final_paper_bench/_runset_locked.tsv \
        --panel realworld \
        --tiers 3 1 \
...
def main() -> int:
    ...
    p.add_argument("--owner", required=True,
                   help="Tag for the output sweep dir (e.g. 'shard-a' or 'shard-b').")
