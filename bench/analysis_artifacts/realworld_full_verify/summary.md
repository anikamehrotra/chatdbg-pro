...
Combines fresh local Anika sweep (`shard-a-paper-final-realworld-20260511-T*-*`) with pre-bound cells in `final_paper_bench/realworld/` (sourced from earlier archive sweeps via `_provenance.json`).
